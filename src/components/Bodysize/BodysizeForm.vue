<template>
    <md-dialog ref="dialog">
        ...
        <md-dialog-actions>
            ...
            <md-button v-if="method === 'create'" class="md-primary" @click="saveBodysize('bodysizeDialog')">Сохранить
            </md-button>
            <md-button v-if="method === 'update'" class="md-primary" @click="updateBodysize('bodysizeDialog')">
                Обновить
            </md-button>
        </md-dialog-actions>
    </md-dialog>
