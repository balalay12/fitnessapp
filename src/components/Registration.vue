            ...
            <md-layout md-tag="md-card" md-column md-flex="30" md-flex-medium="40" md-flex-small="60"
                ...
                <md-card-content>
                    <md-input-container v-bind:class="{ 'md-input-invalid': $v.first_name.$error }">
                        <label>Имя</label>
                        <md-input name="first_name" v-model="first_name" @input="$v.first_name.$touch()"
                                  required></md-input>
                    ...
                    <md-input-container v-bind:class="{ 'md-input-invalid': $v.last_name.$error }">
                        <label>Фамиля</label>
                        <md-input name="last_name" v-model="last_name" @input="$v.last_name.$touch()"
                                  required></md-input>
                    ...
                    <md-input-container v-bind:class="{ 'md-input-invalid': $v.password.$error }">
                        <label>Пароль</label>
                        <md-input name="password" v-model="password" type="password" @input="$v.password.$touch()"
                                  required></md-input>
                    ...
                    <md-input-container v-bind:class="{ 'md-input-invalid': $v.repeatPassword.$error }">
                        <label>Пароль</label>
                        <md-input name="repeatPassword" v-model="repeatPassword" type="password"
                                  @input="$v.repeatPassword.$touch()" required></md-input>
